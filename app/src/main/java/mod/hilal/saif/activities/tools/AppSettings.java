...
public class AppSettings extends AppCompatActivity {
    ...
    private void setupViews() {
        ...
        createToolsView(R.drawable.icon_pallete, getString(R.string.appearance), getString(R.string.appearance_description), content, openSettingsActivity(SettingsActivity.SETTINGS_APPEARANCE_FRAGMENT), false);
